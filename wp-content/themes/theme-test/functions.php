<?php
/**
 * Theme Test functions and definitions
 *
...
function theme_test_scripts() {
	...
	wp_enqueue_style( 'theme-test-style', get_stylesheet_uri(), array(), _S_VERSION );
	...
	wp_enqueue_script( 'theme-test-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
